...
export default function Contact() {
    ...
    return (
        <section id="WorkTogether" className="flex flex-col justify-between  items-center md:p-6 pt-10 h-[60vh] w-[100vw]">
            ...
            <h2 className="text-4xl font-bold text-center dark:text-white text-black m-10">Work Together</h2>
            ...
            <div className="w-full flex md:flex-row flex-col justify-center items-center h-4/6">
                <form className="md:w-3/6 md:max-w-sm mx-auto m-10">
                    ...
                    <div className="relative">
                        <div className="absolute inset-y-0 start-0 flex items-center ps-2.5 pointer-events-none text-primary-600 dark:text-primary-200">
                            <AtSign />
                        </div>
                    ...
                    <div className="relative">
                        <div className="absolute inset-y-5 -start-1.5 flex items-center ps-4 pointer-events-none text-primary-600 dark:text-primary-200">
                            <MailOpen />
                        </div>
                    </div>
